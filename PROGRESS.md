...
- 106 offline tests passing (84 before the audit).
...
1. Validate real filings across the seven-company watchlist with manually checked dates and values. Calibrate missing debt concepts without conflating partial balances with total debt.
