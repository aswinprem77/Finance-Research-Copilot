...
- 123 offline tests passing (84 before the audit).
...
- Hosted GitHub Actions passed the offline test and synthetic-demo workflow on commit `b49aa76`.

## Next work, in priority order

1. Run `python -m src.evaluation.review_app`, independently verify all 29 values and label all 175 passages, then compile/run the real benchmark. Calibrate missing debt concepts without conflating partial balances with total debt.
